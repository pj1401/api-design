...
**Primary resource:** Tracks (track_id, track_name, duration_ms, genre, year, danceability, mode, valence)
...
För albumnamn: [🎹 Spotify Tracks Dataset](https://www.kaggle.com/datasets/maharshipandya/-spotify-tracks-dataset) Eller hämta info från spotify API?
